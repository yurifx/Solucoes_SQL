...
PRINT ' '
PRINT ' -- **************************************'
PRINT ' -- **            SMTI150014.sql ' 
PRINT ' -- **************************************'


 -- Atualiza tabela de controle de scripts executados
insert into gemco_scripts_executados (script, dthrexecucao) select 'SMTI150014.sql', getdate()
go
...
AS
  ...
  --* JAN 22, 2015 - PFERNANDES 4540 - Inclusão das colunas ALIQIBPTEST,        *
  --*                ALIQIBPTMUN, CHAVEIBPT, FONTEIBPT, VLIBPTEST, VLIBPTMUN    * 
  --*****************************************************************************
...
--pfernandes - 4540 - inicio 
  DECLARE @ALIQIBPTEST NUMERIC (4,2)
  DECLARE @ALIQIBPTMUN NUMERIC (4,2)
  DECLARE @CHAVEIBPT   VARCHAR (20)
  DECLARE @FONTEIBPT   VARCHAR (30)
  DECLARE @VLIBPTEST   NUMERIC (15,2)
  DECLARE @VLIBPTMUN   NUMERIC (15,2)
--pfernandes - 4540 - fim
  ...
  @FLOFFLINE, @CODAUTDESCPDV, @NUMCOO, @ALIQIBPTEST, @ALIQIBPTMUN, @CHAVEIBPT, 
  @FONTEIBPT, @VLIBPTEST, @VLIBPTMUN
...
--                 END
       ...
       BEGIN --Roberto Cesar - 135549
		...
		@NUMCOO, @ALIQIBPTEST, @ALIQIBPTMUN, @CHAVEIBPT, @FONTEIBPT, @VLIBPTEST, @VLIBPTMUN
